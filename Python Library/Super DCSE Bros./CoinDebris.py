...
class CoinDebris(object):
    ...
    def __init__(self, x_pos, y_pos):
        self.rect = pg.Rect(x_pos, y_pos, 16, 28)#assigning a space for a block to hold the coin
...
#Loading the sprites into the block
    def update(self, core):#Function to run this animation and render it
        self.image_tick += 1
