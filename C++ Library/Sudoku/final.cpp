...
int main()
{
    ...
    int gridx[N][N] = {{3, 0, 6, 5, 0, 8, 4, 0, 0},
                      {5, 2, 0, 0, 0, 0, 0, 0, 0},
                      {0, 8, 7, 0, 0, 0, 0, 3, 1},
                      {0, 0, 3, 0, 1, 0, 0, 8, 0},
                      {9, 0, 0, 8, 6, 3, 0, 0, 5},
    ...
    cout<<endl<<endl<<"------- Now Start Solving ------\n"<<endl;
...
//    int grid[9][9];
    for (int row = 0; row < 9; row++)
    {
        for (int col = 0; col < 9; col++){
            if(gridx[row][col] == 0){
                //cout<<"Put value for column "<<col+1 <<" and row "<<row+1<<" ";
                cin>>gridx[row][col];
    ...
    cout<<endl<<endl;
    if (!flag)
        cout<<"You just solved it! Great ";
    else
	{
        cout<<"You solved it the wrong way \n Solution is: "<<endl;
        printGrid(grid);
        cout<<endl;
    }
