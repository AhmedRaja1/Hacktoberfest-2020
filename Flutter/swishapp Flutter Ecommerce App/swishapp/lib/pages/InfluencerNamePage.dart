...
import 'package:swishapp/pages/displayImagescreen.dart';

class InfluencerName extends StatefulWidget {
  final String profilePictureURL;
  InfluencerName(this.profilePictureURL);
  @override
  _InfluencerNameState createState() => _InfluencerNameState();
}

class _InfluencerNameState extends State<InfluencerName> {
